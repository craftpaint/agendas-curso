                    ...
                    <div class="send_form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-4">
                                ...
                                <select disabled class="select2 form-select" required name="tipo_vehiculo">
                                    <option <?= ($vehiculo['tipo_vehiculo'] == 'Motocicleta') ? 'selected' : '' ?> value="Motocicleta">Motocicleta</option>
                                    <option <?= ($vehiculo['tipo_vehiculo'] == 'Automóvil particular') ? 'selected' : '' ?> value="Automóvil particular">Automóvil particular</option>
                                    <option <?= ($vehiculo['tipo_vehiculo'] == 'Taxi') ? 'selected' : '' ?> value="Taxi">Taxi</option>
                                </select>
                            </div>
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Placa de vehiculo <span class="required_flied">*</span></label>
                                <input readonly type="text" class="form-control" name="placa_vehiculo" required value="<?= $vehiculo['placa_vehiculo'] ?>">
                            </div>
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Modelo de vehiculo <span class="required_flied">*</span></label>
                                <input readonly type="text" class="form-control" name="modelo_vehiculo" required value="<?= $vehiculo['modelo_vehiculo'] ?>">
                            </div> 
                        </div>
                    </div>
                </div>
