    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="send_form" action="{{url('dashboard/clientes/update')}}">
                        <input type="hidden" name="id_cliente" value="<?= $cliente['id_cliente'] ?>">
                        <div class="row">
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Nombre <span class="required_flied">*</span></label>
                                <input type="text" class="form-control" name="nombre_cliente" required value="<?= $cliente['nombre_cliente'] ?>">
                            </div>
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Apellido <span class="required_flied">*</span></label>
                                <input type="text" class="form-control" name="apellido_cliente" required value="<?= $cliente['apellido_cliente'] ?>">
                            </div>
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Correo <span class="required_flied">*</span></label>
                                <input type="text" class="form-control" name="email_cliente" required value="<?= $cliente['email_cliente'] ?>">
                            </div>
                            <div class="mb-4 col-md-4">
                            ...
                            <div class="mb-4 col-md-4">
                                ...
                                <input type="text" class="form-control" name="doc_cliente" required value="<?= $cliente['doc_cliente'] ?>">
                            </div>
                            <div class="mb-4 col-md-4">
                                <label class="form-label">Teléfono <span class="required_flied">*</span></label>
                                <input type="text" class="form-control" name="telefono_cliente" id="phoneCliente" required value="<?= $cliente['telefono_cliente'] ?>">
                            </div>
                            <div class="mb-4 col-md-12">
                                <label class="form-label">Descripción <span class="required_flied">*</span></label>
                                <textarea class="form-control" rows="3" name="desc_cliente" required><?= $cliente['desc_cliente'] ?></textarea>
                            </div>
                        </div>
