    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <h2 class="content-header-title">Crear Rol</h2>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo url('dashboard/roles/store'); ?>" method="POST">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="role-name" name="name" class="form-control" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name'], ENT_QUOTES, 'UTF-8') : ''; ?>" required>
                            </div>
                            <div class="mb-1">
                                <label for="role-name" class="form-label">Nombre del Rol:</label>
                                <input type="text" id="role-name" name="name" class="form-control" value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name'], ENT_QUOTES, 'UTF-8') : ''; ?>" required>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" id="role-icon" name="icon" class="form-control" placeholder="Ej: feather icon-user" value="<?php echo isset($_POST['icon']) ? htmlspecialchars($_POST['icon'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            </div>
