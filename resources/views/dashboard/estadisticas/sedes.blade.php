    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="p-4">
                    <p>Rango fechas acual: <span id="ConTextRangoFechas"></span>
                    </p>
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        <div class="p-4 d-flex align-items-center justify-content-between">
                            <h5 class="m-0">Comparativa Semanal: Fechas de Creación</h5>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="card">
                        <div class="p-4 d-flex align-items-center justify-content-between">
                            <h5 class="m-0">Comparativa Semanal: Fechas de Reserva</h5>
                        </div>
                        <div class="card-datatable text-nowrap">
                            <div class="chart-container">
