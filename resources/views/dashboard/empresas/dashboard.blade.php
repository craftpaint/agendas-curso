            ...
            <div class="row d-flex align-items-stretch">
                ...
                <div class="mb-3 col-md-3 d-flex">
                    <div class="card w-100">
                        <div class="card-body">
                            <h3 class="card-title mb-4 "><i class="ti ti-box fs-1 me-2"></i> Paquete Activo
                            </h3>
                ...
                <div class="mb-3 col-md-3 d-flex">
                    <div class="card w-100">
                        <div class="card-body d-flex flex-column">
                            <h4 class="card-title text-info"><i class="ti ti-package-export fs-1 me-2"></i> Citas
                                Consumidas</h4>
                ...
                <div class="mb-3 col-md-3 d-flex">
                    <div class="card w-100">
                        <div class="card-body d-flex flex-column">
                            <h3 class="card-title verde"><i class="ti ti-packages fs-1 me-2"></i> Citas Faltantes
                            </h3>
                            <h1 class="card-text mb-1 text-center display-1"
                ...
                <div class="mb-3 col-md-3 d-flex">
                    <div class="card w-100">
                        <div class="card-body">
                            <h3 class="card-title "><i class="ti ti-building-skyscraper fs-1 me-2"></i>Información</h3>
            ...
            <div class="mt-3">
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="card h-100">
                            <div class="card-body">
                                <h3><i class="ti ti-history text-primary fs-1 me-2"></i> Historial de paquetes</h3>
                                <div class="row">
                                    <div class="col-md-3 row justify-content-center align-item-center">
                                        <div id="ChartRadialProgressDashboardEmpresasHistorial" class="col-12 h-100"></div>
                                    </div>
                                    <div class="col-md-7 row justify-content-center align-item-center">
                                        <div id="ChartRadialProgressDashboardEmpresasHistorialInfo" class="col-12 h-100"></div>
                                    </div>
                                    <div class="col-md-3 row h-100 justify-content-center align-item-center">
                                        <div id="ChartRadialProgressDashboardEmpresasHistorialBoton" class="col-12 h-100 w-100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
