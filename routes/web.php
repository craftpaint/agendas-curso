...
// Rutas de perfil
Route::middleware(['auth', 'prevent.cache', 'prevent.cache'])->group(function () {
...
Route::controller(EstadisticasController::class)->group(function () {
    ...
    Route::get('dashboard/estadisticas/agentes', 'estadisticasAgentes')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:estadisticas.panel2.v']);
    ...
    Route::get('dashboard/estadisticas/sedes', 'estadisticasSedes')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:estadisticas.panel3.v']);
...
Route::controller(SedesController::class)->group(function () {
    ...
    Route::get('dashboard/sedes', 'index')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.listado.v'])
        ->name('sedes.index');
    Route::post('dashboard/sedes/get_sedes', 'get_sedes')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.listado.v|cita.Ver sede.v']);
    // Agregar sede: "sede.sede.a"
    Route::get('dashboard/sedes/add', 'add')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.sede.a'])
        ->name('sedes.add');
    Route::post('dashboard/sedes/save', 'save')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.sede.a']);
    // Editar sede: "sede.sede.e"
    Route::get('dashboard/sedes/view/{id}', 'edit')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.sede.e'])
        ->name('sedes.view');
    ...
    Route::post('dashboard/sedes/delete_sede', 'delete_sede')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.sede.d']);
    // Configuración: "sede.configuracion.v"
    Route::get('dashboard/sedes/configuracion', 'configuracion')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.configuracion.v']);
    // Horarios
    Route::post('dashboard/sedes/get_horarios', 'get_horarios')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.horarios.v']);
    Route::post('dashboard/sedes/add_horarios', 'add_horarios')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.horarios.a']);
    Route::post('dashboard/sedes/delete_horario', 'delete_horario')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.horarios.d']);
    // Días festivos
    Route::post('dashboard/sedes/get_festivos', 'get_festivos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.dias_festivos.v']);
    Route::post('dashboard/sedes/add_festivos', 'add_festivos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.dias_festivos.a']);
    Route::post('dashboard/sedes/delete_festivos', 'delete_festivos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.dias_festivos.d']);
    // Servicios
    Route::post('dashboard/sedes/get_servicio', 'get_servicio')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.servicios.v']);
    Route::post('dashboard/sedes/add_servicio', 'add_servicio')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.servicios.a']);
    Route::post('dashboard/sedes/delete_servicio', 'delete_servicio')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.servicios.d']);
    ...
    Route::post('dashboard/sedes/get_ciudades', 'get_ciudades')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.Ciudades.v']);
    Route::post('dashboard/sedes/add_ciudad', 'add_ciudad')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.Ciudades.a']);
    Route::post('dashboard/sedes/change_estado_ciudad', 'change_estado_ciudad')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:sede.Ciudades.d']);
...
Route::controller(ClientesController::class)->group(function () {
    ...
    Route::get('dashboard/clientes', 'index')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.listado.v'])
        ->name('clientes.index');
    ...
    Route::get('dashboard/clientes/add', 'add')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.Cliente.a'])
        ->name('clientes.add');
    Route::post('dashboard/clientes/save', 'save')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.Cliente.a']);
    // Ver cliente: "cliente.Cliente.v"
    Route::get('dashboard/clientes/view/{id}', 'view')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.Cliente.v'])
        ->name('clientes.view');
    // Editar cliente: "cliente.Cliente.e"
    Route::get('dashboard/clientes/edit/{id}', 'edit')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.Cliente.e'])
        ->name('clientes.edit');
    ...
    Route::post('dashboard/clientes/delete_cliente', 'delete_cliente')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.Cliente.d']);
    // Vehículos (Listado de vehículos: "vehiculo.listado.v")
    Route::get('dashboard/clientes/vehiculos', 'vehiculos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:vehiculo.listado.v'])
    ...
    Route::get('dashboard/clientes/get_vehiculo/{id}', 'view_vehiculos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:vehiculo.Vehiculo.v']);
    // Agregar vehículo: "vehiculo.Vehiculo.a"
    Route::get('dashboard/clientes/add_vehiculos', 'add_vehiculos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:vehiculo.Vehiculo.a'])
    ...
    Route::get('dashboard/clientes/edit_vehiculos/{id}', 'edit_vehiculos')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:vehiculo.Vehiculo.e'])
    ...
    Route::post('dashboard/clientes/delete_vehiculo', 'delete_vehiculo')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:vehiculo.Vehiculo.d']);
    // Descargar clientes: "cliente.descargar.v"
    Route::post('dashboard/clientes/dowload', 'dowload')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cliente.descargar.v']);
...
Route::controller(CitasController::class)->group(function () {
    ...
    Route::get('dashboard/citas', 'index')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.listado.v'])
        ->name('citas.index');
    ...
    Route::get('dashboard/citas/edit/{id}', 'edit')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Cita.e'])
        ->name('citas.edit');
    // Ver cita: "cita.Cita.v"
    Route::get('dashboard/citas/view/{id}', 'view')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Cita.v'])
        ->name('citas.view');
    ...
    Route::post('dashboard/citas/change_estado_verificado', 'change_estado_verificado')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Estado Verificado.e']);
    // Cambiar agente call center: "cita.Agente Call Center.e"
    Route::post('dashboard/citas/change_agente_call', 'change_agente_call')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Agente Call Center.e']);
    ...
    Route::get('dashboard/citas/get_estado_metodo_scraping', 'get_estado_metodo_scraping')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Metodo scraping.e']);
...
Route::controller(UsersController::class)->group(function () {
    ...
    Route::get('dashboard/usuarios', 'index')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:usuario.Usuario.v'])
        ->name('usuarios.index');
    Route::post('dashboard/usuarios/get', 'get')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:usuario.Usuario.v']);
    // Agregar usuario: "usuario.usuario.a"
    Route::post('dashboard/usuarios/save', 'save')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:usuario.Usuario.a']);
    // Editar usuario: "usuario.Usuario.e"
    Route::post('dashboard/usuarios/update', 'update')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:usuario.Usuario.e']);
    // Eliminar usuario: "usuario.Usuario.d"
    Route::post('dashboard/usuarios/delete', 'delete')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:usuario.Usuario.d']);
...
Route::controller(CitasController::class)->group(function () {
    ...
    Route::get('dashboard/liquidador', 'indexLiquidador')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:liquidador.Listado.v'])
    ...
    Route::post('dashboard/liquidador/get_servicio_liquidador', 'get_servicio_liquidador')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Servicio Liquidador.v']);
    Route::post('dashboard/liquidador/add_servicio_liquidador', 'add_servicio_liquidador')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Servicio Liquidador.a']);
    Route::get('dashboard/liquidador/edit_servicio_liquidador/{id}', 'edit_servicio_liquidador')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Servicio Liquidador.e']);
    ...
    Route::post('dashboard/liquidador/updateComentario', 'updateComentario')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.Anotaciones.e']);
    Route::post('dashboard/liquidador/updatePagoMasivo', 'updatePagoMasivo')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:liquidador.Pago Realizado.e']);
    Route::post('dashboard/liquidador/dowloadLiquidador', 'dowloadLiquidador')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:cita.listado.v']);
})->name('liquidador');

// Roles (Gestión de Roles)
Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:roles.Roles.v'])->group(function () {
...
Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:permissions.administrar.v'])->group(function () {
...
Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.listado.v'])->group(function () {
...
Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.Empresa.a'])->group(function () {
    Route::post('dashboard/empresas/guardar', [EmpresasController::class, 'guardarEmpresa'])->name('empresas.guardarEmpresa');
});

Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.Empresa.e'])->group(function () {
    Route::post('dashboard/empresas/actualizar/{id}', [EmpresasController::class, 'actualizar'])->name('empresas.actualizar');
});

Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.Empresa.d'])->group(function () {
    Route::post('dashboard/empresas/cambiar_estado/', [EmpresasController::class, 'cambiarEstado'])->name('empresas.cambiarEstado');
});

Route::middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.Empresa.a'])
...
Route::controller(EmpresasController::class)->group(function () {
    Route::get('dashboard/empresa', 'obtenerDashboardEmpresa')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:empresa.dashboard.v']);
...
Route::controller(PaquetesController::class)->group(function () {
    Route::get('dashboard/paquetes', 'index')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:paquete.listado.v'])
        ->name('paquetes.index');
    ...
    Route::post('dashboard/paquetes/cambio_estado', 'cambioEstadoPaquete')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:paquete.listado.d']);
    Route::post('dashboard/paquetes/guardar', 'guardarPaquete')
        ->middleware(['auth', 'prevent.cache', 'verified', 'permission:paquete.listado.a']);
